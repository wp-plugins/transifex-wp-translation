...
class TXWT_Plugin_Settings {
    ...
    public static function txwt_admin_pages_callback() {
        self::$pages[] = add_menu_page(__("Transifex", 'txwt'), __("Transifex", 'txwt'), 'manage_options', 'txwt-plugin', __CLASS__.'::txwt_plugin_pages');
        self::$pages[] = add_submenu_page('txwt-plugin', __("Advanced", 'txwt'), __("Advanced", 'txwt'), 'manage_options', 'txwt-plugin_switcher', __CLASS__.'::txwt_plugin_pages');
    }
